...
namespace Potassium\App\Notifications;
...
class CustomerPasswordResetEmail extends Notification
{
    public $token;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action('Réinitialiser mon mot de passe', url(route('front.password.reset', $this->token, false)))
