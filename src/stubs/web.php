...
Route::group(["prefix"=>"admin","middleware"=>"auth", 'namespace' => 'Admin'], function(){
    ...
    */
    Route::group(["prefix"=>"traductions", 'middleware' => 'right:traductions'], function(){
    ...
    Route::resource('traductions','TraductionsController')->middleware('right:traductions');


    /**
    * Routes pour les utilisateurs
    */
    Route::group(['prefix'=>'utilisateurs', 'middleware' => 'right:users'], function(){
